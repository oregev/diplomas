...
export const Form = ({
  ...
  <S.FormContainer>
    <S.InputContainer>
      <Label htmlFor="courseName" content="Template name" />
      <Input
        id="courseName"
        name="courseName"
        type="text"
    ...
    <S.InputContainer>
      <Label htmlFor="courseDuration" content="Duration" />
      <S.RangeContainer>
        <S.Range
          id="courseDuration"
          name="courseDuration"
          ...
          min="0"
          max="80"
          value={content.courseDuration ?? template?.courseDuration}
          onChange={onChange}
        />
        <S.Duration>({content.courseDuration ?? template?.courseDuration})</S.Duration>
      </S.RangeContainer>
    ...
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      <S.InputContainer>
        <Label htmlFor="start" content="Start date" />
        <S.Date
          id="start"
          name="start"
          type="date"
      ...
      <S.InputContainer>
        <Label htmlFor="end" content="End date" />
        <S.Date
          id="end"
          name="end"
          type="date"
    ...
    <S.InputContainer>
      <Label htmlFor="lecturer" content="Lecturer" />
      <Input
        id="lecturer"
        name="lecturer"
        type="text"
    ...
    <S.InputContainer>
      <Label htmlFor="course" content="Course" />
      <S.Select
        id="course"
        name="course"
    ...
    <span style={{ fontSize: 10, color: "#999" }}>
      (when checked you will be moved to uploads when generating a template)
    </span>
  </S.FormContainer>
);
